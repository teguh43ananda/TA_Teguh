...
from PySide2.QtWidgets import QGroupBox, QGridLayout, QLabel, QVBoxLayout
import numpy as np
...
class KickToOpen():
    ...
    def setupGUI(self, gridLayout, demoTabs, device):
        ...
        ktoTempDict['powerplot'].setFixedHeight(220)
        ...
        ktoTempDict['presenceplot'].setFixedHeight(220)
        ...
        ktoTempDict['dopplerplot'].setFixedHeight(220)
